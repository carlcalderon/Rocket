...
function parse(cwd, inputDirectory, outputDirectory, files, folders) {
    ...
    var result = "Schematic:".bold + tab(1) + "+".grey.inverse + " Copy/Concat " + "+".green.inverse + " Compile " + "+".cyan.inverse + " Minify " + "+".yellow.inverse + " Exec" + CRLF + CRLF,
        file = null,
        temp = "",
        len = 0,
        i = 0;
