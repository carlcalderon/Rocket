...
// PATTERNS
//============================================================
    REGEXP_NOTATION = function() { return /<\!--\s?(rocket|sb):\s?([\S]+)\s?(\S*?)\s?-->([\s\S]*?)<\!--\s?end\s?-->/gm; },
...
//============================================================
/**
 * Splits the specifed content into individual rows.
 * @param  {String} content Content with multiple rows.
...
/**
 * Parses the specified content for notation blocks.
 * @param  {String} content        Content
 * @param  {String} inputDirectory Configuration directory
            ...
            default :
                ...
                if (links != null) {
                    for (i = 0, len = links.length; i < len; i++) {
                        console.log(links[i]);
                        sources.push(utils.resolve(inputDirectory, REGEXP_LINK().exec(links[i])[1]));
                    };
